...
<option value="4">ADITYA BUSINESS SCHOOLS/COLLEGES</option>

</select><br><br>

<label for="course"> Interested Courses:</label><br> <p>Which you are interested
...
<input type="checkbox" name="course[]" value="MERN Stack">MERN Stack<br>

<input type="checkbox" name="course[]" value="AWS">AWS<br>

<input type="checkbox" name="course[]" value="PowerBI">PowerBI<br><br>
